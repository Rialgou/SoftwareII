    ...
    <Container fluid style={{ height: '100vh' }}>
      <Row style={{ height: '100%' }}>
          ...
          <Row style={{ flex: '55%' }}>
            <Col className='headerColo'>
              <motion.h1
                ...
                initial={{ rotate: 0 }}
                animate={{ rotate: 360 }}
                transition={{ duration: 0.6, repeat: Infinity, repeatType: 'loop', repeatDelay: 5 }}
              >
        ...
        <Col md={4} className='columna222'>
          <Stack direction='horizontal' gap={5}>
              <Button variant='outline-primary' className='botones-home' onClick={handleDebButtonClick}>
                Depurador
              </Button>
              <Button variant='outline-danger' className='botones-home' onClick={handleAdminButtonClick}>
                Administrador
              </Button>
              <Button variant='outline-success' className='botones-home' onClick={handleUserButtonClick}>
                Usuario
              </Button>
            </Stack>
        </Col>
